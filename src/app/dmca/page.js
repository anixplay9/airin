    ...
    <div>
      ...
      <div className="mx-auto w-[94%] lg:w-[80%]">
        ...
        <p className="mt-4 text-[#bdbdbd]">
          anixplay.xyz is committed to respecting the intellectual property
        ...
        <p className="mt-4 text-[#bdbdbd]">
          None of the files listed on anixplay.xyz are hosted on our servers. All
          ...
          to{" "}
          <Link href="mailto:contact@anixplay.xyz" className="text-white">
            contact@anixplay.xyz
          </Link>{" "}
