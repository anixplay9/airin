...
import { seasonOptions, genreOptions, tagsOptions, formatOptions, yearOptions, sortbyOptions, AnixPlaygOptions } from './options';
...
function Catalog({ searchParams }) {
    ...
    // const [AnixPlaygvalue, setAnixPlaygvalue] = useState(null);
            ...
            <div className={styles.catalogtop}>
                ...
                {showTopBottom && <>
                    <div className={styles.toptwo}>
                        ...
                        {/* <div className={styles.catalogsort}>
                        <h3 className={styles.searchlabel}>AnixPlayg Status</h3>
                        <Select
                            labelPlacement={"outside"}
                            label=""
                            aria-label="Sort by"
                            ...
                            selectedKeys={sortbyvalue}
                            className="max-w-xs"
                            onSelectionChange={setAnixPlaygvalue}
                        >
                            {AnixPlaygOptions.map((item) => (
                                <SelectItem key={item.value} value={item.value}>
                                    {item.name}
                                </SelectItem>
                            ))}
